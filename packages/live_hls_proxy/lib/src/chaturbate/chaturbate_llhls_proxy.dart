...
class ChaturbateLlHlsProxy {
  ...
  void _logSyntheticPlaylistDecision({
    ...
    if (!_platformAdapter.kDebugMode || playlistSegments.isEmpty) {
      return;
    }
    ...
    _platformAdapter.debugPrint('ChaturbateLlHlsProxy $message');
    _platformAdapter.log('chaturbate/proxy', message);
  }
