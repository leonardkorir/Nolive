...
void main() {
  ...
  test(
    'in-memory follow repository upserts removes and clears records',
    () async {
  ...
  test(
    'in-memory follow repository keeps order when updating existing record',
    () async {
      final repository = InMemoryFollowRepository();
      await repository.upsert(
        const FollowRecord(
      ...
      expect(
        follows.last.streamerAvatarUrl,
