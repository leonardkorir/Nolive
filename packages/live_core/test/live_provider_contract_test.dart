...
void main() {
  group('LiveProvider Contract and Capability checks', () {
    ...
    test(
      'requireCapability throws ProviderCapabilityException if capability is unsupported',
      () {
        final provider = MockSearchProvider();
        expect(
    ...
    test(
      'requireContract returns cast provider if capability and class interface match',
      () {
        final provider = MockSearchProvider();
        expect(
    ...
    test(
      'requireContract throws ProviderContractException if capability is supported but interface is not implemented',
      () {
