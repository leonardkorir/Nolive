...
class HuyaMapper {
  ...
  static LiveRoom mapSearchRoom(Map<String, dynamic> item) {
    ...
    return LiveRoom(
      ...
      roomId: 'yy/${item['yyid']}',
      title: title,
      streamerName: item['game_nick']?.toString() ?? '',
      coverUrl: cover,
      keyframeUrl: cover,
  ...
  static LiveRoomDetail mapRoomDetail(
    ...
    return LiveRoomDetail(
      ...
      streamerName: liveInfo['nick']?.toString() ?? '',
      ...
      areaName: liveInfo['gameFullName']?.toString(),
      description: liveInfo['introduction']?.toString(),
