  ...
  static Future<dynamic> _handleMethodCall(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "onHistoryChanged":
        ...
        unawaited(
          _otherIsolateMessageHandler
              .invokeMethod('onHistoryChanged', {
                'webViewId': viewId,
      ...
      case "onNavigationStarted":
        ...
        unawaited(
          _otherIsolateMessageHandler
              .invokeMethod('onNavigationStarted', {
                'webViewId': viewId,
              })
              .catchError((_) {}),
        );
      ...
      case "onUrlRequested":
        ...
        // Must return promptly — native DecidePolicy holds the navigation
        // until this completes. Do not await title-bar isolate broadcast
        // (title bar may be absent on Linux GTK header path).
      ...
      case "onWebMessageReceived":
        ...
        unawaited(
          _otherIsolateMessageHandler
              .invokeMethod('onWebMessageReceived', {
                'webViewId': viewId,
                'message': message,
              })
              .catchError((_) {}),
