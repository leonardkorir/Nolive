...
void main() {
  test(
    'follow transfer imports legacy-compatible follow json and creates tags',
    () async {
      ...
      expect(bilibiliFollow.lastCoverUrl, 'https://example.com/cover-a.png');
      expect(
  ...
  test(
    'follow transfer exports current follows in legacy-compatible shape',
    () async {
      final bootstrap = createAppBootstrap(mode: AppRuntimeMode.preview);
      ...
      expect(first['keyframeUrl'], 'https://example.com/huya-keyframe.png');
      expect(first['tag'], '比赛');
