...
void main() {
  test(
    'room follow action coordinator follows current room into snapshot',
    () async {
  ...
  test(
    'room follow action coordinator keeps state when unfollow is canceled',
    () async {
      final bootstrap = createAppBootstrap(mode: AppRuntimeMode.preview);
  ...
  test(
    'room follow action coordinator removes current room after confirm',
    () async {
      final bootstrap = createAppBootstrap(mode: AppRuntimeMode.preview);
      await bootstrap.followRepository.upsert(
        const FollowRecord(
  ...
  test(
    'room follow action coordinator does not navigate for current room',
    () async {
      final bootstrap = createAppBootstrap(mode: AppRuntimeMode.preview);
