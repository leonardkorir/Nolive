...
void main() {
  ...
  test(
    'chaturbate ll-hls proxy rewrites media playlists into standard hls',
    () async {
...
''';
      final assets = <String, List<int>>{
        '/v1/edge/streams/origin.demo/init_2_video_llhls.m4s?session=test': utf8
            .encode('video-init'),
        '/v1/edge/streams/origin.demo/seg_2_7245_video_llhls.m4s?session=test':
            utf8.encode('video-seg-7245'),
        '/v1/edge/streams/origin.demo/seg_2_7246_video_llhls.m4s?session=test':
            utf8.encode('video-seg-7246'),
        '/v1/edge/streams/origin.demo/init_7_audio_llhls.m4s?session=test': utf8
            .encode('audio-init'),
        '/v1/edge/streams/origin.demo/seg_7_7246_audio_llhls.m4s?session=test':
      ...
      final videoUri = RegExp(
        r'http://127\.0\.0\.1:\d+/chaturbate-llhls/[^\s]+/video\.m3u8',
      ).firstMatch(masterText)!.group(0)!;
      final videoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final videoText = utf8.decode(
        await videoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
  ...
  test(
    'chaturbate ll-hls proxy starts at self-initialized segment without map',
    () async {
      final upstream = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
      final baseUrl = 'http://${upstream.address.host}:${upstream.port}';
      const videoPlaylist = '''
...
''';
      final selfInitializedVideo = Uint8List.fromList(<int>[
        0,
        0,
        0,
        8,
      ...
      final selfInitializedAudio = Uint8List.fromList(<int>[
        0,
        0,
        0,
        8,
  ...
  test(
    'chaturbate ll-hls proxy remembers delayed self-initialized segment',
    () async {
      final upstream = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
      final baseUrl = 'http://${upstream.address.host}:${upstream.port}';
      const videoPlaylist = '''
...
''';
      ...
      final proxy = ChaturbateLlHlsProxy(enabledOverride: true);
      final wrapped = await proxy.wrapPlayUrls(
        quality: LivePlayQuality(id: '1800000', label: '480p'),
        playUrls: [
          LivePlayUrl(
            url:
                '$baseUrl/v1/edge/streams/origin.demo/chunklist_2_video_llhls.m3u8?session=test',
      ...
      final firstVideoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final firstVideoText = utf8.decode(
        await firstVideoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
      ...
      final secondVideoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final secondVideoText = utf8.decode(
        await secondVideoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
  ...
  test(
    'chaturbate ll-hls proxy can serve startup playlist before full cache',
    () {
      expect(
  ...
  test('chaturbate ll-hls proxy resolves startup policy by bitrate tier', () {
    expect(
      resolveChaturbateLlHlsStartupPolicy(bandwidth: 1800000, height: 480),
      (
        warmSegmentCount: 6,
    ...
    expect(
      resolveChaturbateLlHlsStartupPolicy(bandwidth: 2096000, height: 540),
      (
        warmSegmentCount: 8,
    ...
    expect(
      resolveChaturbateLlHlsStartupPolicy(bandwidth: 5128000, height: 1080),
      (
        warmSegmentCount: 10,
        minimumStartupPlayableSegmentCount: 6,
...
''';
  ...
  test('chaturbate ll-hls proxy keeps a stable rolling segment window', () async {
    final upstream = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
    final baseUrl = 'http://${upstream.address.host}:${upstream.port}';
...
''',
    ...
    final assets = <String, List<int>>{
      '/v1/edge/streams/origin.demo/init_2_video_llhls.m4s?session=test': utf8
          .encode('video-init'),
      '/v1/edge/streams/origin.demo/seg_2_10_video_llhls.m4s?session=test': utf8
          .encode('video-seg-10'),
      '/v1/edge/streams/origin.demo/seg_2_11_video_llhls.m4s?session=test': utf8
          .encode('video-seg-11'),
      '/v1/edge/streams/origin.demo/seg_2_12_video_llhls.m4s?session=test': utf8
          .encode('video-seg-12'),
      '/v1/edge/streams/origin.demo/seg_2_13_video_llhls.m4s?session=test': utf8
          .encode('video-seg-13'),
      '/v1/edge/streams/origin.demo/seg_2_14_video_llhls.m4s?session=test': utf8
          .encode('video-seg-14'),
      '/v1/edge/streams/origin.demo/init_7_audio_llhls.m4s?session=test': utf8
          .encode('audio-init'),
      '/v1/edge/streams/origin.demo/seg_7_10_audio_llhls.m4s?session=test': utf8
          .encode('audio-seg-10'),
      '/v1/edge/streams/origin.demo/seg_7_11_audio_llhls.m4s?session=test': utf8
          .encode('audio-seg-11'),
      '/v1/edge/streams/origin.demo/seg_7_12_audio_llhls.m4s?session=test': utf8
          .encode('audio-seg-12'),
      '/v1/edge/streams/origin.demo/seg_7_13_audio_llhls.m4s?session=test': utf8
          .encode('audio-seg-13'),
      '/v1/edge/streams/origin.demo/seg_7_14_audio_llhls.m4s?session=test': utf8
          .encode('audio-seg-14'),
    };
    upstream.listen((request) async {
      final path = request.requestedUri.path;
    ...
    final proxy = ChaturbateLlHlsProxy(enabledOverride: true);
    final wrapped = await proxy.wrapPlayUrls(
      quality: LivePlayQuality(id: '2096000', label: '540p', sortOrder: 540),
      playUrls: [
        LivePlayUrl(
          url:
              '$baseUrl/v1/edge/streams/origin.demo/chunklist_2_video_llhls.m3u8?session=test',
    ...
    expect(RegExp(r'#EXTINF:').allMatches(secondVideoText).length, 3);
  ...
  test(
    'chaturbate ll-hls proxy warms startup video assets before playback',
    () async {
      final upstream = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
      final baseUrl = 'http://${upstream.address.host}:${upstream.port}';
      const videoPlaylist = '''
...
''';
      ...
      final firstSegmentResponse = await (await client.getUrl(
        Uri.parse(assetUris[1]),
      )).close();
      final firstSegmentBody = utf8.decode(
        await firstSegmentResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
...
''';
      ...
      final audioUri = RegExp(
        r'http://127\.0\.0\.1:\d+/chaturbate-llhls/[^\s]+/audio\.m3u8',
      ).firstMatch(masterText)!.group(0)!;

      final stopwatch = Stopwatch()..start();
      final audioResponse = await (await client.getUrl(
        Uri.parse(audioUri),
      )).close();
      final audioText = utf8.decode(
        await audioResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
      ...
      expect(
        RegExp(r'#EXTINF:').allMatches(audioText).length,
...
''';
      ...
      final initialVideoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final initialVideoText = utf8.decode(
        await initialVideoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
      ...
      final stopwatch = Stopwatch()..start();
      final cachedVideoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final cachedVideoText = utf8.decode(
        await cachedVideoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
...
''';
      ...
      final firstSegmentCount = RegExp(
        r'#EXTINF:',
      ).allMatches(firstVideoText).length;
      expect(firstSegmentCount, greaterThanOrEqualTo(4));

      await Future<void>.delayed(const Duration(milliseconds: 400));

      final stopwatch = Stopwatch()..start();
      final pendingVideoResponse = (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
    ...
    () async {
      ...
      final assets = <String, List<int>>{
        ...
        for (var sequence = 200; sequence < 210; sequence += 1)
          '/v1/edge/streams/origin.demo/seg_2_$sequence.m4s?session=test': utf8
              .encode('video-$sequence'),
        for (var sequence = 200; sequence < 210; sequence += 1)
          '/v1/edge/streams/origin.demo/seg_7_$sequence.m4s?session=test': utf8
...
''';
      final assets = <String, List<int>>{
        ...
        for (var sequence = 80; sequence < 90; sequence += 1)
          '/v1/edge/streams/origin.demo/seg_2_$sequence'
              '_video_llhls.m4s?session=test': utf8.encode(
            'video-seg-$sequence',
          ),
        for (var sequence = 80; sequence < 90; sequence += 1)
          '/v1/edge/streams/origin.demo/seg_7_$sequence'
              '_audio_llhls.m4s?session=test': utf8.encode(
            'audio-seg-$sequence',
          ),
      };
      upstream.listen((request) async {
        ...
        if (path.endsWith('chunklist_2_video_llhls.m3u8')) {
          ...
          final isLateStableSegment =
              fullPath.contains('seg_2_84_video_llhls') ||
      ...
      final stableVideoResponse = await (await client.getUrl(
        Uri.parse(videoUri),
      )).close();
      final stableVideoText = utf8.decode(
        await stableVideoResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
    ...
    () async {
      ...
      final wrapped = await proxy.wrapPlayUrls(
        quality: LivePlayQuality(
          ...
          label: '480p',
          sortOrder: 480,
          metadata: {'bandwidth': 1800000, 'width': 854, 'height': 480},
        ),
        playUrls: [
          LivePlayUrl(
            url:
      ...
      final stopwatch = Stopwatch()..start();
      final lateAssetResponseFuture = (await client.getUrl(
        lateAssetUri,
      )).close();
      await Future<void>.delayed(const Duration(milliseconds: 250));
      lateAssetAvailable = true;
      final lateAssetResponse = await lateAssetResponseFuture;
      final lateAssetBody = utf8.decode(
        await lateAssetResponse.fold<List<int>>(
          <int>[],
          (buffer, data) => buffer..addAll(data),
        ),
      );
