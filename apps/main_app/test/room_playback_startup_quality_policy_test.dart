...
void main() {
  ...
  final p720 = LivePlayQuality(id: '720', label: '720p', sortOrder: 720);
  final p1080 = LivePlayQuality(id: '1080', label: '1080p', sortOrder: 1080);

  test(
    'youtube on android keeps auto startup quality to preserve HLS auto',
    () {
      final quality = resolveRoomStartupRequestedQuality(
        providerId: ProviderId.youtube,
        qualities: [auto, p720, p1080],
