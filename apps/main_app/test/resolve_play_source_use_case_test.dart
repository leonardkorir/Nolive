...
void main() {
  ...
  test(
    'resolve play source exposes effective bilibili quality from url',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source prefers bilibili url matching requested qn',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source maps external audio metadata into playback source',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test('playback source maps preferred hls bitrate metadata', () {
    ...
    final source = playbackSourceFromLivePlayUrl(
      playUrl,
      quality: LivePlayQuality(id: '5128000', label: '1080p', sortOrder: 1080),
    );
  ...
  test('resolve play source marks 1440p stream as heavy stable', () async {
    ...
    final quality = LivePlayQuality(id: 'hd', label: '高清', sortOrder: 100);
    final useCase = ResolvePlaySourceUseCase(registry);
  ...
  test(
    'resolve play source marks high bandwidth stream as heavy stable',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source marks blue-ray quality label as heavy stable',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source maps stripchat doppiocdn ll-hls onto dedicated low latency profile',
    () async {
      const playUrl = LivePlayUrl(
        url:
            'https://media-hls.doppiocdn.com/b-hls-12/112319207/112319207_1080p60.m3u8'
            '?minHeight=240&playlistType=lowLatency&psch=v2&pkey=test',
        metadata: {
          'masterPlaylistUrl':
              'https://edge-hls.doppiocdn.com/hls/112319207/master/'
              '112319207_auto.m3u8?minHeight=240&playlistType=lowLatency',
        },
      );
      final quality = LivePlayQuality(
        id: '1080p60',
  ...
  test(
    'resolve play source keeps default low latency profile for plain stream',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source prefers douyu line that keeps requested quality',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source exposes douyu fallback quality from metadata',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source wraps chaturbate ll-hls when proxy is available',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
  ...
  test(
    'resolve play source wraps stripchat ll-hls when proxy is available',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
            ...
            builder: _FakeStripchatPlayUrlProvider.new,
          ),
        );
      const detail = LiveRoomDetail(
        ...
        streamerName: 'Tester',
        isLive: true,
        sourceUrl: 'https://zh.stripchat.com/fit_vic',
      );
      final quality = LivePlayQuality(
        id: '1080p',
        label: '1080P',
      ...
      expect(resolved.playbackSource.url.toString(), contains('127.0.0.1'));
      expect(resolved.playbackSource.url.path, contains('stripchat-llhls'));
      expect(
        resolved.playbackSource.bufferProfile,
  ...
  test(
    'resolve play source maps stripchat stable fallback when proxy is unavailable',
    () async {
      final registry = ProviderRegistry()
        ..register(
          ProviderRegistration(
      ...
      // wrapStripchatPlayUrls is null/returns empty to simulate proxy bypass/unavailable
      final useCase = ResolvePlaySourceUseCase(
        registry,
        wrapStripchatPlayUrls: null,
      );
  ...
  test('resolve play source prefers twitch popout line before site', () async {
    ...
    final quality = LivePlayQuality(id: 'auto', label: 'Auto', isDefault: true);
    final useCase = ResolvePlaySourceUseCase(registry);
...
class _FakeBilibiliPlayUrlProvider extends LiveProvider
  ...
  Future<List<LivePlayUrl>> fetchPlayUrls({
    ...
    return [
      LivePlayUrl(url: 'https://example.com/live.flv?qn=250&expected_qn=250'),
    ];
  }
}
...
class _FakeDouyuPreferredLineProvider extends LiveProvider
  ...
  Future<List<LivePlayUrl>> fetchPlayUrls({
    ...
    return [
      ...
      LivePlayUrl(url: 'https://example.com/origin.flv', metadata: {'rate': 0}),
    ];
  }
}
...
class _FakeHeavyLabelProvider extends LiveProvider implements SupportsPlayUrls {
  ...
  Future<List<LivePlayUrl>> fetchPlayUrls({
    ...
    return [LivePlayUrl(url: 'https://example.com/plain.m3u8')];
  }
}
...
class _FakeStripchatPlayUrlProvider extends LiveProvider
    implements SupportsPlayUrls {
  @override
  ProviderDescriptor get descriptor => const ProviderDescriptor(
    id: ProviderId.stripchat,
  ...
  Future<List<LivePlayUrl>> fetchPlayUrls({
    ...
    return [
      const LivePlayUrl(
        url:
            'https://media-hls.doppiocdn.com/b-hls-11/222064808/222064808_1080p.m3u8'
            '?minHeight=240&playlistType=lowLatency&psch=v2&pkey=test',
        headers: {'referer': 'https://zh.stripchat.com/fit_vic'},
        lineLabel: '1080p',
        metadata: {
          'masterPlaylistUrl':
              'https://edge-hls.doppiocdn.com/hls/222064808/master/'
              '222064808_auto.m3u8?minHeight=240&playlistType=lowLatency',
          'masterPlaylistContent': '#EXTM3U',
        },
      ),
    ];
  ...
  Future<List<LivePlayUrl>> fetchPlayUrls({
    ...
    return [
      LivePlayUrl(
        ...
        lineLabel: 'PHX',
        metadata: {'bandwidth': 1830000, 'width': 960, 'height': 540},
      ),
    ];
  }
}
