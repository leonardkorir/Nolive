...
void main() {
  test('page sync does not interrupt fractional user swipes', () {
    expect(
      shouldSynchronizeRoomPanelPage(
        selectedPanelIndex: RoomPanel.superChat.index,
        controllerPage: 1.24,
  ...
  testWidgets(
    'tab selection synchronizes PageController and side effects once',
    (tester) async {
