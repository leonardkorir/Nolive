...
void main() {
  ...
  testWidgets('Linux Twitch WebPlaybackBridge path', (tester) async {
  ...
  testWidgets('Linux YouTube nsig-wired play path', (tester) async {
    if (!Platform.isLinux) return;
    final adapter = _linuxAdapter();
  ...
  testWidgets('Linux Chaturbate LL-HLS wrap path', (tester) async {
    if (!Platform.isLinux) return;
    final adapter = _linuxAdapter();
  ...
  testWidgets('Linux Stripchat LL-HLS wrap path', (tester) async {
    if (!Platform.isLinux) return;
    final adapter = _linuxAdapter();
